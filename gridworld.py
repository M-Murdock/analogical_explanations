...
def main():
    ...
    # states_embedding_space = EmbeddingSpace(N_GRAM_TYPE="states")
    # states_embedding_space.new_model()
    # states_embedding_space.load_model()
    
    actions_embedding_space = EmbeddingSpace(N_GRAM_TYPE="actions")
    actions_embedding_space.new_model()
    # actions_embedding_space.load_model()
    
    # state_action_reward_embedding_space = EmbeddingSpace(N_GRAM_TYPE="state-action-reward")
